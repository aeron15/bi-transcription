function [data,paramVals,textHeader] = read_fcs_light(filename)
% FCSREAD_LIGHT read selected channels in a FACS FCS format file. Based on
% fcsread.
% 
%
...
%%Trim data and paramVals to extract only a few fields

%get the index of the columns with the following fields

namesParams={paramVals.Name};

%ColumnsToExtract=[find(strcmp(namesParams,'Time'))
%find(strcmp(namesParams,'FSC-A')) find(strcmp(namesParams,'FSC-H')) find(strcmp(namesParams,'SSC-A')) find(strcmp(namesParams,'SSC-H')) find(strcmp(namesParams,'FITC-A')) find(strcmp(namesParams,'FITC-H'))];
%ColumnsToExtract=[find(strcmp(namesParams,'Time')) find(strcmp(namesParams,'FSC-A')) find(strcmp(namesParams,'FSC-H')) find(strcmp(namesParams,'SSC-A')) find(strcmp(namesParams,'SSC-H')) find(strcmp(namesParams,'FITC-A')) find(strcmp(namesParams,'FITC-H')) find(strcmp(namesParams,'PE-H'))];
ColumnsToExtract=[find(strcmp(namesParams,'Time')) find(strcmp(namesParams,'FSC-H')) find(strcmp(namesParams,'SSC-H')) find(strcmp(namesParams,'FITC-H')) find(strcmp(namesParams,'DsRed-H')) find(strcmp(namesParams,'Pacific Blue-H'))  find(strcmp(namesParams,'PE-H')) ];


data=data(:,ColumnsToExtract);

paramVals=paramVals(ColumnsToExtract);
